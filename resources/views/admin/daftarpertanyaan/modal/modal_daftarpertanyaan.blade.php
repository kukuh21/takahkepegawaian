<!-- Modal-->
<div class="modal fade" id="modalpertanyaan" data-backdrop="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="nama_pertanyaan" id="nama_pertanyaan" autocomplete="off"/>
            </div>
            <div class="form-group">
