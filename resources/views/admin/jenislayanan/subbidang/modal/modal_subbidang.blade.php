<!-- Modal-->
<div class="modal fade" id="modalsubbidang" data-backdrop="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    ...
    <form id="form-input" class="form-horizontal" data-toggle="validator" method="post">
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            <input type="hidden" name="bidang_id" id="bidang_id" value="{{ $bidang->bidang_id }}">
            <div class="form-group">
              <label>Nama Sub Bidang</label>
              <input type="text" class="form-control" name="nama_sub_bidang" id="nama_sub_bidang" autocomplete="off"/>
            </div>
          </div>
